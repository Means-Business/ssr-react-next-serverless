  ...
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="flex flex-wrap -m-4">
      <div class="p-4 lg:w-1/4 md:w-1/2">
        <div key={key} class="h-full flex flex-col items-center text-center">
          <img alt="team" class="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-4" src={dog.url}>
          <div class="w-full">
